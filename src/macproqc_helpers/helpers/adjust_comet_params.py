...
def argparse_setup(subparsers: argparse._SubParsersAction):
    parser = subparsers.add_parser(
        "adjust-comet-params",
        description="Adjust Comet parameters for use in McQuaC and write them to a new file.",
    ...
    parser.set_defaults(func=adjust)


def adjust(args: argparse.Namespace) -> None:
