...
def argparse_setup(subparsers: argparse._SubParsersAction):
    parser = subparsers.add_parser(
        "collect-metrics-from-featurexml",
        description="Collect quality metrics from a FeatureXML file and write them into an HDF5 file. The FeatureXML should have already annotated identifications.",
...
def collect_metrics_from_featurexml(args: argparse.Namespace) -> None:
